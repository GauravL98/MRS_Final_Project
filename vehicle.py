import pygame as pg
from utils import DRONE_V, limit, constrain, bivariateFunction, derivativeBivariate, normalFunction
...
class Vehicle(object):
    ...
    def __init__(self, x,y, behavior, window):
        ...
        self.radius = DRONE_RADIUS # Drone Size
        self.desired = vec2()
        # closest drone
        ...
        # color for target, is used to differentiate visually during simulation
        self.color_target = Target_color
    ...
    def draw(self, window):
        ...
        if self.closest_drone:
            pg.draw.line(self.window, SL_color, self.location, self.closest_drone , 1)
    ...
    def collision_avoidance(self, positions_drones , pos_obstacles , index):
        ...
        for p in pos_obstacles:
            ...
            if ( d < dist_avoid ) :
                ...
                if (d < RADIUS_OBSTACLES + DRONE_RADIUS):
