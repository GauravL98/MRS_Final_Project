...
background_image = pygame.image.load(BACK_GROUND_IMAGE).convert_alpha()
background_image = pygame.transform.scale(background_image,(SCREEN_WIDTH,SCREEN_HEIGHT))

# defines initial target position
target = vec2(1400,600)

simulation = Simulation(screenSimulation, RateSimulation(1, [4,5], [6,7], [DefineTargetScan(),ColumnScan_Seek(),ColumnScan_A_star()]))
    #  Possible Scan Methods:
    # - DefineTargetScan()
    # - DefineTargetScan_A_star()
    # - ColumnScan_A_star()
    # - ColumnScan_Seek()
