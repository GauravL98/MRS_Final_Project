...
class DRONE_V(pg.sprite.Sprite):
    """
    ...
    def __init__(self):
        ...
        for i in range(0,4):
            self.sprites.append(pg.image.load(f'models/Drone/sprite_{i}.png').convert_alpha())
        ...
        # scales down drone 
        self.image = pg.transform.scale(self.image,(DRONE_RADIUS*2,DRONE_RADIUS*2))
        self.rect = self.image.get_rect()

    def update(self, position, angle, size = DRONE_RADIUS* PIX2M):
...
class target_O(pg.sprite.Sprite):
    """
        Represents a simple visual target 
        Can load sprites, rotate and update animation
    """
    def __init__(self):
        pg.sprite.Sprite.__init__(self)
        self.sprites = []
        self.sprites.append(pg.image.load(f'models/texture/dr3.png').convert_alpha())
...
class Tree(pg.sprite.Sprite):
    ...
    def __init__(self):
        ...
        for i in range(1,2):
            self.sprites.append(pg.image.load(f'models/tree/tree_{i}.png').convert_alpha())
