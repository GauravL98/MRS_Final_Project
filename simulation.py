...
class Simulation(object):
    ...
    def create_swarm_uav(self, num_swarm, search_pattern = 'DefineTargetScan'):
        ...
        for d in range(0, num_swarm):
            ...
            drone = Vehicle(uniform(0,50), uniform(0,50), self.behaviors[-1], self.screenSimulation.screen)
    ...
    def draw_obstacles(self):
        ...
        for _ in self.list_obst: 
            ...
            pygame.draw.circle(self.screenSimulation.screen,(130, 0, 0), _, radius=RADIUS_OBSTACLES, width=1)
            pygame.draw.circle(self.screenSimulation.screen,(50, 50, 50), _, radius=RADIUS_OBSTACLES*1.6 + AVOID_DISTANCE, width=1)
    ...
    def draw_target(self):
        ...
        if self.target_simulation: 
            ...
            pygame.draw.circle(self.screenSimulation.screen, (0,255,0), self.target_simulation, RADIUS_TARGET, 2)
